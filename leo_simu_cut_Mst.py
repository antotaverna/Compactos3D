...
#El for recorre cada halo y va escribiendo las propiedades de sus subhalos.
for i in range(len(first)):
    ...
    for j in range(len(subhalos['SubhaloCM'][ii])):
        ...
        cadena=str(subhalos['SubhaloGrNr'][ii][j])+\
              '  '+str(subhalos['SubhaloCM'][ii][j][0])+\
              '  '+str(subhalos['SubhaloCM'][ii][j][1])+\
              '  '+str(subhalos['SubhaloCM'][ii][j][2])+\
              '  '+str(subhalos['SubhaloPos'][ii][j][0])+\
              '  '+str(subhalos['SubhaloPos'][ii][j][1])+\
              '  '+str(subhalos['SubhaloPos'][ii][j][2])+\
              '  '+str(subhalos['SubhaloVel'][ii][j][0])+\
              '  '+str(subhalos['SubhaloVel'][ii][j][1])+\
              '  '+str(subhalos['SubhaloVel'][ii][j][2])+\
              '  '+str(subhalos['SubhaloVelDisp'][ii][j])+\
              '  '+str(subhalos['SubhaloSFR'][ii][j])+\
              '  '+str(mag[ii][j][0])+\
              '  '+str(mag[ii][j][1])+\
              '  '+str(mag[ii][j][2])+\
              '  '+str(mag[ii][j][3])+\
              ...
              '  '+str(mag[ii][j][6])+\
              '  '+str(mag[ii][j][7])+\
              #'  '+str(subhalos['SubhaloHalfmassRad'][ii][j])+\
              #'  '+str(subhalos['SubhaloMass'][ii][j])+\
              #'  '+str(subhalos['SubhaloStellarPhotometricsMassInRad'][ii][j])+\
              #'  '+str(subhalos['SubhaloStellarPhotometricsRad'][ii][j])+\
              '  '+str(subhalos['SubhaloMassInRadType'][ii][j][4])+\   #Type=4 Stars --> stellar mass
              '  '+str(subhalos['SubhaloHalfmassRadType'][ii][j][4])+\ #Type=4 Stars --> radio de luz(blending)
              '  '+str(first[i])+\
              '  '+str(n_subs[i])+\
              '  '+str(halos['Group_M_Crit200'][i])+\
              '  '+str(halos['Group_M_Mean200'][i])+\
              '  '+str(halos['Group_R_Crit200'][i])+\
              '  '+str(halos['Group_R_Mean200'][i])+\
              '  '+str(halos['GroupCM'][i][0])+\
              '  '+str(halos['GroupCM'][i][1])+\
              '  '+str(halos['GroupCM'][i][2])+\
              '  '+str(halos['GroupPos'][i][0])+\
              '  '+str(halos['GroupPos'][i][1])+\
              '  '+str(halos['GroupPos'][i][2])+\
              '  '+str(halos['GroupVel'][i][0])+\
              '  '+str(halos['GroupVel'][i][1])+\
              '  '+str(halos['GroupVel'][i][2])+\
              '\n'
        f.write(cadena)
f.close()
